...
fn test_vmandn_mm(sew: u64) {
    fn op(lhs: &[u8], rhs: &[u8], result: &mut [u8], sew: u64, lmul: i64, avl: u64) {
        vop_vv(lhs, rhs, result, sew, avl, lmul, || unsafe {
            rvv_asm!("vmandnot.mm v24, v1, v11");
        });
    }
    run_vmop_mm(
        sew,
