...
use rvv_testcases::{
    intrinsic::{vl1r_v0, vl1r_v1, vl1r_v24, vs1r_v24, vsetvl},
    log,
...
fn test_vslideup(wide: usize) {
    ...
    vl1r_v24(&expected_before[..]);
    unsafe {
        rvv_asm!("vslideup.vi v24, v1, 3, v0.t",);
...
fn test_vslidedown(wide: usize) {
    ...
    vl1r_v24(&expected_before[..]);
    unsafe {
        rvv_asm!("vslidedown.vi v24, v1, 3, v0.t",);
        vs1r_v24(&mut result2[..]);
    }
